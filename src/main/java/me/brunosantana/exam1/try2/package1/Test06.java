...
public class Test06 {
    public static void main(String [] args) {
        ...
        //process(list, (Employee e) -> { return e.getSalary() >= 10000; }); //OK
        //process(list, e -> e.getSalary() >= 10000); //OK
        //process(list, e -> { return e.getSalary() >= 10000;} ); //OK
        //process(list, (e) -> { return e.getSalary() >= 10000;} ); //OK
        process(list, (e) -> e.getSalary() >= 10000 ); //OK
        //process(list, (e) -> { e.getSalary() >= 10000; }); //Compilation error
        //process(list, e -> { e.getSalary() >= 10000 } ); //Compilation error
        //process(list, e - > e.getSalary() >= 10000); //Compilation error
